...
// 		counterleft += matrix[i][i];
// 		counterright += matrix[i][matrix.length - 1 - i];
// 	}
//   return Math.abs(counterleft - counterright)
// }
// console.log(diagonal_sum(matrix));

// /* 6. give a string “cvs health”, change it to “Cvs Health” */
// const str = "cvs health"

// function capitalize(word){
//     const newWord = word.split(' ')

//     const res = newWord.map((word) => word[0].toUpperCase() + word.slice(1));
...
// const uppercase = (str) =>
//   [...str].map((char, i) => (str.substring(0, i) + char.toUpperCase() + str.substring(i + 1)));
/* 1st + st[i].toUpperCase() + 3rd */
